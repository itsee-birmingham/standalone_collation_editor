 ...
 ```javascript
   getApparatusForContext = function (successCallback)  {
    ...
    $.fileDownload(url, {
      ...
      //can also add a failCallback here if required
    });
  };
