...
var SimpleContextMenu = {
    ...
    _show : function (e) {
        ...
        if (menuElementId !== null) {
            ...
            if (menuElementId) {
                ...
                if (parseInt(SimpleContextMenu._menuElement.style.left) - document.getElementById('scroller').scrollLeft  + 110 > window.innerWidth) {
                	SimpleContextMenu._menuElement.style.left = window.innerWidth + document.getElementById('scroller').scrollLeft - (110 + 35) + 'px';
                }
    ...
    _getScrollPosition : function () {
        var x = 0;
        var y = 0;
        if( document.getElementById('scroller') && ( document.getElementById('scroller').scrollLeft || document.getElementById('scroller').scrollTop ) ) {
